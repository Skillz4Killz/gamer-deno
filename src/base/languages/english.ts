export const english = {
    ...
    RANDOM_NUMBER_DESCRIPTION: "Random Number Generator",
    RANDOM_MIN_NAME: "min",
    RANDOM_MIN_DESCRIPTION: "The minimum number?",
    RANDOM_MAX_NAME: "max",
    RANDOM_MAX_DESCRIPTION: "The maximum number?",
    RANDOM_8BALL_NAME: "8ball",
    RANDOM_8BALL_DESCRIPTION: "8 ball",
    RANDOM_QUESTION_NAME: "question",
    RANDOM_QUESTION_DESCRIPTION: "The question?",
    RANDOM_ADVICE_NAME: "advice",
    RANDOM_ADVICE_DESCRIPTION: "advice",
