...
export const english = {
    ...
    ROLES_REACTIONS_CREATE_INVALID_MESSAGE_ID: (serverInviteCode: string) => `❌ The message ID you provided does not seem to be a valid message id. Please try again. If you need help contact us at, https://discord.gg/${serverInviteCode}`,
    ...
    INVALID_EMBED_JSON_CODE: (serverInviteCode: string) => `❌ The embed code you provided was not valid JSON. Need help? Join https://discord.gg/${serverInviteCode}`,
