...
export const english = {
    ...
    USER_NOT_ADMIN: "⚠️ Only admins are allowed to use this.",
    ...
    EMBED_CREATE_CODE_NAME: "code",
    EMBED_CREATE_CODE_DESCRIPTION: "🖼️ The JSON formatted code.",
    ...
    EMBED_MODAL_URL_LABEL_PLACEHOLDER: (serverInviteCode: string) => `https://discord.gg/${serverInviteCode}`,
