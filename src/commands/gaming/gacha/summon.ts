    ...
    execute: async function (message, args: CommandArgs) {
        ...
        if (!profile) {
            ...
            return sendResponse(message, [
                ...
                translate(message.guildID, "strings:GACHA_FIRST_4", { invite: botCache.constants.botSupportInvite }),
            ].join('\n'))
        }
        ...
        db.gachas.update(message.author.id, {
            ...
            ownedCharacters: [...profile.ownedCharacters, ...loot.filter(i => characters.some(e => e.id === i)).map(i => ({     
                id: i,
                experience: 0,
                skin: 0 
            }))],
