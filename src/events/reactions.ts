...
botCache.eventHandlers.reactionAdd = async function (message, emoji, userID) {
  ...
  botCache.helpers.todoReactionHandler(fullMessage, emoji, userID).catch(
    console.log,
  );
  botCache.helpers.handleFeedbackReaction(fullMessage, emoji, userID).catch(
    console.log,
  );
...
botCache.eventHandlers.reactionRemove = async function (
  ...
  botCache.helpers.removeFeedbackReaction(fullMessage, emoji, userID).catch(
    console.log,
  );
